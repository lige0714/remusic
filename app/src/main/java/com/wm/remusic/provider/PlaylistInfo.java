...
public class PlaylistInfo {
    ...
    public void updatePlaylistMusicCount(long[] PlaylistId) {
        ...
        selection.append(PlaylistInfoColumns.PLAYLIST_ID + " IN (");//查找playlist
        ...
        try {
            ...
            if (cursor != null && cursor.moveToFirst()) {
                ...
                do {
                    int count = cursor.getInt(cursor.getColumnIndex(PlaylistInfoColumns.SONG_COUNT)) - 1; //歌曲数量-1
