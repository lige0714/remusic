...
public class PlaylistDetailAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    @Override
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {  //每个Item inflater出一个View，但是该方法返回的是一个ViewHolder。
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder itemHolder, final int i) {
        if (itemHolder instanceof ItemViewHolder) {
            ...
            ((ItemViewHolder) itemHolder).menu.setOnClickListener(new View.OnClickListener() {  //歌曲最右边 信息
                @Override
            ...
            ((CommonItemViewHolder) itemHolder).textView.setText("(共" + arraylist.size() + "首)");   //播放全部

            ((CommonItemViewHolder) itemHolder).select.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) { //点击最右边 选择
    ...
    public class CommonItemViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {      //播放全部
        TextView textView;
        ImageView select;
    ...
    public class ItemViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {    //单一歌曲
