    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        switch (item.type) {
            case LvMenuItem.TYPE_NORMAL:
                if (convertView == null) {
                    convertView = mInflater.inflate(R.layout.design_drawer_item, parent,  //创建一个新 元素
                            false);
                }
                ...
                if (icon != null) {
                    ...
                    TextViewCompat.setCompoundDrawablesRelative(itemView,  null, null,icon, null);//将图片放在 textView 的text前边  上边 后边 下边
                }
