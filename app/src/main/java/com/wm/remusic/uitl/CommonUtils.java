...
public class CommonUtils {
    ...
    public static int getStatusHeight(Context context) {  //获取状态栏高度
...
//    }
    ...
    public static int getActionBarHeight(Context context) {
        ...
        context.getTheme().resolveAttribute(R.attr.actionBarSize, mTypedValue, true);  //获取ActionBar的高度 到 mTypedValue

        mActionBarHeight = TypedValue.complexToDimensionPixelSize(mTypedValue.data, context.getResources().getDisplayMetrics()); //转成像素

        return mActionBarHeight;  //获取 像素级数据
    }
